...
For audit process guidelines see link:MLPerf_Audit_Guidelines.adoc[MLPerf Audit Guidelines].
...
A: All submitters must use the following parameters. Quantization is allowed within the rules of MLPerf Inference. All component prompt prefix are to be ramined as in the reference implementation.
